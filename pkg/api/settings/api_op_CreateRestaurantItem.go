...
func (s *SSettings) CreateRestaurantItem() openapi.ContextHandler {
	return func(ctx context.Context, c *gin.Context) {
		var input CreateRestaurantItemDto
		var fileName string
		...
		proto, err := s.RestaurantItemClient.CreateRestaurantItem(ctx, &settingsProto.CreateRestaurantItemRequest{
		...
		c.JSON(http.StatusCreated, buildRestaurantItemResponse(proto.GetResult()))
	}
}

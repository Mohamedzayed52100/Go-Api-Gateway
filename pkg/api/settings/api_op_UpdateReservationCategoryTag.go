...
func (s *SSettings) UpdateReservationCategoryTag() openapi.ContextHandler {
	return func(ctx context.Context, c *gin.Context) {
		var input openapi.UpdateReservationCategoryTagRequest
		common.ResolveRequestBody(c, &input)
		id := common.ConvertStringToInt(c.Param("tagId"))

		proto, err := s.ReservationTagClient.UpdateReservationTag(ctx, &settingsProto.UpdateReservationTagRequest{

...
func (s *SSettings) UpdateTable() openapi.ContextHandler {
	return func(ctx context.Context, c *gin.Context) {
		var input openapi.UpdateTableRequest
		...
		proto, err := s.TableClient.UpdateTable(ctx, &settingsProto.UpdateTableRequest{
		...
		c.JSON(http.StatusOK, buildTableResponse(proto.GetResult()))
	}
}

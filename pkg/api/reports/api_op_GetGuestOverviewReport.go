...
func (s *SReports) GetGuestOverviewReport() openapi.ContextHandler {
	return func(ctx context.Context, c *gin.Context) {
		...
		proto, err := s.GuestReportClient.GetGuestOverviewReport(ctx, &reports.ReportRequestParam{
			FromDate:          fromDate,
			ToDate:            toDate,
		...
		c.JSON(http.StatusOK, &openapi.GetOverviewGuestReportResponse{
			Result: buildGuestOverviewReportResponse(proto.GetResult()),
		})
	}
}

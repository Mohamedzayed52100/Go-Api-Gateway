...
func (s *SReports) GetOverviewReservationsReport() openapi.ContextHandler {
	return func(ctx context.Context, c *gin.Context) {
		...
		proto, err := s.OverviewReportClient.GetReservationsSummary(ctx, &reports.ReportRequestParam{
			FromDate:          fromDate,
			ToDate:            toDate,
		...
		c.JSON(http.StatusOK, &openapi.GetOverviewReservationsReportResponse{
			Result: buildOverviewReservationsReport(proto.GetResult()),
		})
	}
}

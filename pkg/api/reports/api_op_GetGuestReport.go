...
func (s *SReports) GetGuestReport() openapi.ContextHandler {
	return func(ctx context.Context, c *gin.Context) {
		...
		proto, err := s.GuestReportClient.GetGuestReport(ctx, &reports.ReportRequestParam{
			FromDate:          fromDate,
			ToDate:            toDate,
		...
		c.JSON(http.StatusOK, buildGuestReportResponse(proto))
	}
}
